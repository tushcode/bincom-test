...
CREATE TABLE IF NOT EXISTS `ng_banks` (
  ...
  `active` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `ng_banks` (`id`, `name`, `code`, `active`) VALUES
(132, 'Page MFBank', '560', '1'),
(133, 'Stanbic Mobile Money', '304', '1'),
(134, 'FortisMobile', '308', '1'),
(135, 'TagPay', '328', '1'),
(136, 'FBNMobile', '309', '1'),
(137, 'First Bank of Nigeria', '011', '1'),
(138, 'Sterling Mobile', '326', '1'),
(139, 'Omoluabi Mortgage Bank', '990', '1'),
(140, 'ReadyCash (Parkway)', '311', '1'),
(141, 'Zenith Bank', '057', '1'),
(142, 'Standard Chartered Bank', '068', '1'),
(143, 'eTranzact', '306', '1'),
(144, 'Fidelity Bank', '070', '1'),
(145, 'CitiBank', '023', '1'),
(146, 'Unity Bank', '215', '1'),
(147, 'Access Money', '323', '1'),
(148, 'Eartholeum', '302', '1'),
(149, 'Hedonmark', '324', '1'),
(150, 'MoneyBox', '325', '1'),
(151, 'JAIZ Bank', '301', '1'),
(152, 'Ecobank Plc', '050', '1'),
(153, 'EcoMobile', '307', '1'),
(154, 'Fidelity Mobile', '318', '1'),
(155, 'TeasyMobile', '319', '1'),
(156, 'NIP Virtual Bank', '999', '1'),
(157, 'VTNetworks', '320', '1'),
(158, 'Stanbic IBTC Bank', '221', '1'),
(159, 'Fortis Microfinance Bank', '501', '1'),
(160, 'PayAttitude Online', '329', '1'),
(161, 'ZenithMobile', '322', '1'),
(162, 'ChamsMobile', '303', '1'),
(163, 'SafeTrust Mortgage Bank', '403', '1'),
(164, 'Covenant Microfinance Bank', '551', '1'),
(165, 'Imperial Homes Mortgage Bank', '415', '1'),
(166, 'NPF MicroFinance Bank', '552', '1'),
(167, 'Parralex', '526', '1'),
(168, 'Wema Bank', '035', '1'),
(169, 'Enterprise Bank', '084', '1'),
(170, 'Diamond Bank', '063', '1'),
(171, 'Paycom', '305', '1'),
(172, 'SunTrust Bank', '100', '1'),
(173, 'Cellulant', '317', '1'),
(174, 'ASO Savings and & Loans', '401', '1'),
(175, 'Heritage', '030', '1'),
(176, 'Jubilee Life Mortgage Bank', '402', '1'),
(177, 'GTBank Plc', '058', '1'),
(178, 'Union Bank', '032', '1'),
(179, 'Sterling Bank', '232', '1'),
(180, 'Skye Bank', '076', '1'),
(181, 'Keystone Bank', '082', '1'),
(182, 'Pagatech', '327', '1'),
(183, 'Coronation Merchant Bank', '559', '1'),
(184, 'FSDH', '601', '1'),
(185, 'Mkudi', '313', '1'),
(186, 'First City Monument Bank', '214', '1'),
(187, 'FET', '314', '1'),
(188, 'Trustbond', '523', '1'),
(189, 'GTMobile', '315', '1'),
(190, 'United Bank for Africa', '033', '1'),
(191, 'Access Bank', '044', '1'),
(567, 'TCF MFB', '90115', '1');

CREATE TABLE IF NOT EXISTS `ng_local` (
  `id` int NOT NULL,
  `state_id` int NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COMMENT='Local governments in Nigeria.';

INSERT INTO `ng_local` (`id`, `state_id`, `name`) VALUES
(1, 1, 'Aba North'),
(2, 1, 'Aba South'),
(3, 1, 'Arochukwu'),
(4, 1, 'Bende'),
...
INSERT INTO `ng_states` (`id`, `name`) VALUES
(1, 'Abia'),
(2, 'Adamawa'),
(3, 'Akwa Ibom'),
(4, 'Anambra'),
...
CREATE TABLE IF NOT EXISTS `queue_email` (
...
CREATE TABLE IF NOT EXISTS `queue_logger` (
...
CREATE TABLE IF NOT EXISTS `template_push` (
  `temp_id` int NOT NULL,
  `temp` varchar(150) NOT NULL,
  `head` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `txt` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `users` (
  `uid` int NOT NULL,
  `refer_by` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `users_token` (
  ...
  `tokens` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `token_type` varchar(50) NOT NULL,
  `date_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


ALTER TABLE `ng_banks`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ng_local`
  ADD PRIMARY KEY (`id`),
  ADD KEY `state_id` (`state_id`);

ALTER TABLE `ng_states`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `queue_email`
  ADD PRIMARY KEY (`queue_id`);

ALTER TABLE `queue_logger`
  ADD PRIMARY KEY (`logger_id`);

ALTER TABLE `template_email`
  ADD PRIMARY KEY (`temp_id`);

ALTER TABLE `template_push`
  ADD PRIMARY KEY (`temp_id`);
